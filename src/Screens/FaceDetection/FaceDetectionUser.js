...
// const FaceDetectionUser = ({ navigation, route }) => {
//   const userProfile = route?.params?.imageObject
...
//       .then(res => {
//         setIsLoading(false)
//         showSuccess('Profile pic uploaded successfully')
//         resetStack()
//       })
//       .catch(error => {
//         setIsLoading(false)
...
//   console.log(userProfile?.data, 'user pic hahahahahh')

//   const getBase64Url = async () => {
//     setImage(true, userProfile?.data, Enum.ImageType.PRINTED)
//     RNFetchBlob.config({
//       fileCache: true
//     })
//       .fetch('GET', userProfile?.path)
//       .then(resp => {
//         setIsLoading(false)
//         imagePath = resp.path()
...
// export default FaceDetectionUser
        ...
        <>
          ...
          {profileDeclined && (
            <View
              ...
              <TouchableOpacity onPress={onPressSignup}>
                <Text style={{...commonStyles.font_14_bold}}> Go Back</Text>
              </TouchableOpacity>
            </View>
          )}
        </>
